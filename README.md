...
#### 나중에 기회가 된다면 이 주제도 유전알고리즘으로 최적해를 구할 수 있는지 알아보겠다.
## **4.개선점과 하면서 새로 배우고 느낀 점**
#### 우선 이번학기 가장 기억에 남는 수업이 뭐냐 하면 당연 컴퓨터 알고리즘 수업였습니다. 단순 코딩 밖에 몰랐던 저를 알고리즘 및 github사용법에 조금이나마 깨닫게 해주신 김동훈 교수님 감사합니다. 소프트웨어 개발자가 되기위해 알고리즘의 중요성을 다시한번 느꼈고 앞으로 공부 방향성을 잡을 수 있을 것같습니다.
#### 또 이번 유전 알고리즘 및 최적해 알고리즘을 공부하면서 프로그래밍으로 정말 다양한 걸 만들 수 있구나 느꼈습니다. 이에 반면 아직 저의 실력은 많이 부족한 것같고 아직 2학년이니까 더 열심히 할 동기가 된것 같습니다. 감사합니다 방학 잘 보내십쇼!